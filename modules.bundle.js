...
const { H: i4  } = R, r3 = (o)=>void 0 === o.strings
...
class FloatingLabelDirective extends i3 {
...
const floatingLabel = e3(FloatingLabelDirective);
var cssClasses6 = {
...
var MDCLineRippleFoundation = function(_super) {
    ...
    MDCLineRippleFoundation.prototype.activate = function() {
        this.adapter.removeClass(cssClasses6.LINE_RIPPLE_DEACTIVATING);
        this.adapter.addClass(cssClasses6.LINE_RIPPLE_ACTIVE);
    };
    MDCLineRippleFoundation.prototype.setRippleCenter = function(xCoordinate) {
        this.adapter.setStyle('transform-origin', xCoordinate + "px center");
    };
    MDCLineRippleFoundation.prototype.deactivate = function() {
        this.adapter.addClass(cssClasses6.LINE_RIPPLE_DEACTIVATING);
    };
    MDCLineRippleFoundation.prototype.handleTransitionEnd = function(evt) {
        var isDeactivating = this.adapter.hasClass(cssClasses6.LINE_RIPPLE_DEACTIVATING);
        if (evt.propertyName === 'opacity') {
            if (isDeactivating) {
                this.adapter.removeClass(cssClasses6.LINE_RIPPLE_ACTIVE);
                this.adapter.removeClass(cssClasses6.LINE_RIPPLE_DEACTIVATING);
            }
        }
    };
...
const createAdapter1 = (lineElement)=>{
    return {
...
class LineRippleDirective extends i3 {
    constructor(partInfo){
        super(partInfo);
        this.previousPart = null;
        this.foundation = null;
    ...
    update(part, _params) {
        if (this.previousPart !== part) {
            ...
            const adapter = createAdapter1(lineElement);
...
const lineRipple = e3(LineRippleDirective);
var strings5 = {
...
class TextFieldBase extends FormElement {
    ...
    render() {
        ...
        return p`
      <label class="mdc-text-field ${o6(classes)}">
        ${this.renderRipple()}
    ...
    renderIcon(icon, isTrailingIcon = false) {
        ...
        return p`<i class="material-icons mdc-text-field__icon ${o6(classes)}">${icon}</i>`;
    }
    renderPrefix() {
    ...
    renderAffix(content, isSuffix = false) {
        ...
        return p`<span class="mdc-text-field__affix ${o6(classes)}">
        ${content}</span>`;
    }
    renderInput(shouldRenderHelperText) {
        ...
        return p`
      <input
          aria-labelledby=${l3(ariaLabelledbyOrUndef)}
          aria-controls="${l3(ariaControlsOrUndef)}"
          aria-describedby="${l3(ariaDescribedbyOrUndef)}"
          ...
          minlength="${l3(minOrUndef)}"
          maxlength="${l3(maxOrUndef)}"
          pattern="${l3(this.pattern ? this.pattern : undefined)}"
          min="${l3(this.min === '' ? undefined : this.min)}"
          max="${l3(this.max === '' ? undefined : this.max)}"
          step="${l3(this.step === null ? undefined : this.step)}"
          size="${l3(this.size === null ? undefined : this.size)}"
          name="${l3(this.name === '' ? undefined : this.name)}"
          inputmode="${l3(this.inputMode)}"
          autocapitalize="${l3(autocapitalizeOrUndef)}"
    ...
    renderHelperText(shouldRenderHelperText, shouldRenderCharCounter) {
      ...
      <div class="mdc-text-field-helper-line">
        <div id="helper-text"
             aria-hidden="${l3(ariaHiddenOrUndef)}"
             class="mdc-text-field-helper-text ${o6(classes)}"
             >${helperText}</div>
    ...
    _checkValidity(value) {
        ...
        if (this.validityTransform) {
            ...
            validity = Object.assign(Object.assign({
...
__decorate([
    i6('.mdc-floating-label')
], TextFieldBase.prototype, "labelElement", void 0);
__decorate([
    i6('.mdc-line-ripple')
], TextFieldBase.prototype, "lineRippleElement", void 0);
__decorate([
    i6('mwc-notched-outline')
...
function i8(t) {
    return (function(t) {
        ...
        if ("Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i)) return r4(t, e);
    })(t) || (function() {
